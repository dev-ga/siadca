        ...
        <div class="text-center ">
            ...
            <div class="mt-5 sm:mt-8 sm:flex sm:justify-center">
                <div class="rounded-md shadow"><a
                        class="flex w-full items-center justify-center rounded-md border border-[#fd033f]  px-8 py-3 text-base font-medium text-white hover:bg-[#fd033f] md:py-4 md:px-10 md:text-lg uppercase"
                        href="#">Registrate!
                    </a>
                </div>
            </div>
