            ...
            <div class="mx-auto mt-10 flex justify-center px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8">
                <div class="text-center ">
                    <h1
                        ...
                        <div class="mt-2">
                            <span class="relative mt-3 whitespace-nowrap text-white"><svg aria-hidden="true" viewBox="0 0 418 42"
                    ...
                    <p class="mx-auto mt-4 max-w-xl text-lg text-gray-500 dark:text-slate-400 sm:mt-5 md:mt-5">
                        Te damos la bienvenida a nuestro nuevo sistema de compras ON-LINE
                    </p>
                    <div class="mt-5 sm:mt-8 sm:flex sm:justify-center">
                        <div class="rounded-md shadow"><a
                                class="flex w-full items-center justify-center rounded-lg border border-[#fd033f]  px-8 py-3 text-base font-medium text-white hover:bg-[#fd033f] md:py-4 md:px-10 md:text-lg uppercase"
                                href="{{ route('register-costumers') }}">Registrate!
                            </a>
                        </div>
                    </div>
                </div>
